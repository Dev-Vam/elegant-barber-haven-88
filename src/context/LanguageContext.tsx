...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'services.expertGrooming': 'Expert Grooming Services',
    'services.premiumProducts': 'Premium Products',
    'services.productsDesc1': 'At KMD Pro Barber, we use and sell only the highest quality grooming products to ensure you look your best long after you leave our shop.',
    ...
    'services.giftCardsDesc': 'Give the gift of premium grooming. Our gift cards are perfect for birthdays, anniversaries, or any special occasion.',
    'services.purchaseGift': 'Purchase a Gift Card',
    'services.readyExperience': 'Ready to Experience Excellence?',
    'services.bookingDesc': 'Book your appointment today and discover why KMD Pro Barber is Pretoria\'s premier destination for sophisticated grooming.',
  ...
  fr: {
    ...
    'services.expertGrooming': 'Services d\'Experts en Toilettage',
    'services.premiumProducts': 'Produits Premium',
    'services.productsDesc1': 'Chez KMD Pro Barber, nous utilisons et vendons uniquement des produits de toilettage de la plus haute qualité pour vous assurer d\'être au meilleur de votre forme longtemps après avoir quitté notre salon.',
    ...
    'services.giftCardsDesc': 'Offrez le cadeau du toilettage premium. Nos cartes cadeaux sont parfaites pour les anniversaires ou toute occasion spéciale.',
    'services.purchaseGift': 'Acheter une Carte Cadeau',
    'services.readyExperience': 'Prêt à Vivre l\'Excellence?',
    'services.bookingDesc': 'Réservez votre rendez-vous aujourd\'hui et découvrez pourquoi KMD Pro Barber est la destination privilégiée de Pretoria pour un toilettage sophistiqué.',
