...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen overflow-hidden">
      <Carousel className="h-full" opts={{ loop: true }} onSelect={(index) => setCurrentSlide(index)}>
          ...
          <div className="flex items-center gap-2">
            {heroSlides.map((_, index) => (
              <button 
                ...
                onClick={() => document.querySelector(`.embla__container`).style.transform = `translateX(-${index * 100}%)`}
